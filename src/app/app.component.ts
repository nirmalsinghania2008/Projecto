  ...
  template: `
    <md-content>
      ...
      <footer>
        ...
        <span>{{name}}<a [href]="url">@nirmalsinghania2008</a></span>
      </footer>
    </md-content>
  `
})
...
export class App {
  ...
  name = 'Projecto- Project Management Application';
  url = 'https://github.com/nirmalsinghania2008';
...
/*
 * For help or questions please contact us at nirmal.singhania@st.niituniversity.in
 */
